...
Route::middleware('year')->group(function () {
    ...
    Route::group(['prefix' => 'filmint'], function () {
        Route::get('registerFilm', [FilmController::class, 'create'])->name('registerFilm'); 
        Route::post('registerFilm', [FilmController::class, 'createFilm'])->name('saveFilm')->middleware('ValidateUrl');
    });
});
